...
search.addEventListener("click", (e) => {
  ...
  const APIKey = "2ad864b8c66fbf1e48caa02088e78306";
  ...
  fetch(
    ...
    .then((json) => {
      ...
      if (cityHide.textContent == city) {
        ...
        elCloneInfoWeather.classList.add("clone-active");

        elCloneInfoHumidity.id = "clone-info-humidity";
        elCloneInfoHumidity.classList.add("clone-active");

        elCloneInfoWind.id = "clone-info-wind";
        elCloneInfoWind.classList.add("clone-active");
